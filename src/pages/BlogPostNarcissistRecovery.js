      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <article className="article-container mx-auto">
          <header className="mb-16 text-left">
            <h1 className="font-bold mb-6">Emotional Manipulation Tactics Narcissist Ex Recovery: 12 Proven Steps to Reclaim Your Life in 2025</h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section id="understanding-manipulation" className="mb-16 scroll-mt-24">
              <h2 className="font-bold mb-4">Understanding Emotional Manipulation Tactics Used by Narcissistic Exes</h2>
              ...
              <h3 className="font-semibold mb-3">The Most Common Manipulation Tactics</h3>
              ...
              <div className="my-8">
                <img 
                  src="/images/confident-woman-standing-triumphantly-at-sunrise-representing-emotional-recovery-and-healing-from-narcissistic-abuse-manipulation-tactics.webp?v=1760798229914" 
              ...
              <h3 className="font-semibold mb-3">The Psychological Impact of These Tactics</h3>
            ...
            <section id="science-behind-manipulation" className="mb-16 scroll-mt-24">
              <h2 className="font-bold mb-4">The Science Behind Narcissistic Manipulation and Trauma Bonding</h2>
              ...
              <h3 className="font-semibold mb-3">How Your Brain Responds to Manipulation</h3>
              ...
              <h3 className="font-semibold mb-3">Breaking Free from Biochemical Bondage</h3>
            ...
            <section id="recovery-steps" className="mb-16 scroll-mt-24">
              <h2 className="font-bold mb-4">12 Essential Steps for Narcissist Ex Recovery</h2>
              
              <h3 className="font-semibold mb-3">Step 1: Acknowledge the Abuse and Stop Minimizing</h3>
              <p className="text-lg text-brand-dark mb-6">
              ...
              <h3 className="font-semibold mb-3">Step 2: Implement Complete No Contact (When Possible)</h3>
              <p className="text-lg text-brand-dark mb-6">
              ...
              <h3 className="font-semibold mb-3">Step 3: Educate Yourself About Narcissistic Personality Disorder</h3>
              <p className="text-lg text-brand-dark mb-6">
              ...
              <div className="my-8">
                <img 
                  src="/images/open-journal-with-a-pen-cup-of-tea-and-small-potted-plant-on-a-white-desk-in-soft-natural-light-evoking-calm-and-reflection.webp?v=1760798229914" 
              ...
              <h3 className="font-semibold mb-3">Step 4: Rebuild Your Support Network</h3>
              <p className="text-lg text-brand-dark mb-6">
            ...
            <section id="rebuilding-identity" className="mb-16 scroll-mt-24">
              <h2 className="font-bold mb-4">Rebuilding Your Identity After Emotional Manipulation</h2>
              ...
              <h3 className="font-semibold mb-3">Reclaiming Your Voice and Opinions</h3>
              <p className="text-lg text-brand-dark mb-6">
              ...
              <h3 className="font-semibold mb-3">Building Self-Compassion and Self-Worth</h3>
              <p className="text-lg text-brand-dark mb-6">
            ...
            <section id="setting-boundaries" className="mb-16 scroll-mt-24">
              <h2 className="font-bold mb-4">Setting Boundaries to Prevent Future Manipulation</h2>
              ...
              <h3 className="font-semibold mb-3">Identifying Your Non-Negotiables</h3>
              <p className="text-lg text-brand-dark mb-6">
              ...
              <div className="my-8">
                <img 
                  src="/images/person-setting-healthy-emotional-boundaries-with-protective-golden-light-representing-recovery-from-narcissist-ex-manipulation-and-self-protection.webp?v=1760798229914" 
            ...
            <section id="professional-help" className="mb-16 scroll-mt-24">
              <h2 className="font-bold mb-4">Professional Help: When to Seek Therapy for Narcissistic Abuse Recovery</h2>
              ...
              <h3 className="font-semibold mb-3">Signs You Need Professional Help</h3>
            ...
            <section id="healing-tools" className="mb-16 scroll-mt-24">
              <h2 className="font-bold mb-4">Supporting Your Healing Journey: Tools and Resources</h2>
              
              <h3 className="font-semibold mb-3">Essential Reading for Recovery</h3>
              ...
              <h3 className="font-semibold mb-3">Your Recovery Timeline: What to Expect</h3>
            ...
            <section id="faq" className="mb-16 scroll-mt-24">
              <h2 className="font-bold mb-4">Frequently Asked Questions About Narcissist Ex Recovery</h2>
            ...
            <section className="border-t pt-12 mt-16">
              <h2 className="font-bold mb-4">Conclusion: Your Journey to Freedom Starts Now</h2>
