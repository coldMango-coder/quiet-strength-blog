        ...
        <article className="article-container mx-auto max-w-[720px]">
          ...
          <section className="bg-white p-8 rounded-lg mb-16 shadow-md text-base">
            ...
            <ul className="space-y-3 toc-list">
              ...
              <li><a href="#sample-routine" className="text-brand-emphasis hover:underline">3. Sample 45â€‘Minute Routine</a></li>
          ...
          <section className="mb-16">
            <p>
              If your mornings currently feel rushed or scattered, you are not alone. The first hour of the day can either steady you or spin you into reactivity. A gentle, repeatable routine is how we choose steadiness on purpose â€” a small set of habits that tell your brain, â€œIâ€™m safe, Iâ€™m capable, and I know where Iâ€™m going.â€
            </p>
            <p>
              This guide is practical and compassionate. You wonâ€™t find perfectionism here â€” just simple actions that compound. Weâ€™ll use what research says about sleep, light, movement, and attention, and weâ€™ll adapt it to real life with kids, deadlines, and unpredictable energy.
            </p>
          </section>
          ...
          <section id="why-mornings" className="mb-16 scroll-mt-24">
            ...
            <p>
              Confidence is learned. Each small, finishable step â€” a glass of water, three lines in a journal â€” becomes evidence your brain stores: â€œI keep promises to myself.â€ Over time that evidence hardens into identity, and identity fuels bigger goals.
            </p>
            <h3 className="mt-6">Conserves Mental Energy</h3>
            <p>
              Systematizing the first 30â€“60 minutes reduces decision fatigue so your best attention is available for meaningful work later. The <a href="https://www.cdc.gov/sleep/about/index.html">CDC</a> and the <a href="https://www.sleepfoundation.org/how-sleep-works/why-do-we-need-sleep">Sleep Foundation</a> both emphasize how consistent rhythms protect mood, memory, and performance.
            </p>
            <h3 className="mt-6">Neurochemical Advantage</h3>
            <StyledList items={[
              'Serotonin rises with morning light exposure â†’ better mood',
              'Dopamine spikes from completed tasks â†’ motivation',
              'Endorphins from movement â†’ stress relief and confidence'
            ]} />
            <h3 className="mt-6">Productivity Anchoring</h3>
            <p>
              With a light structure you start proactively â€” not inside the noise of notifications. The <a href="https://www.apa.org/members/content/social-media-research-series">APA</a> highlights how early social media exposure can pull attention and mood; a routine gently protects both.
            </p>
          </section>

          <section id="five-pillars" className="mb-16 scroll-mt-24">
            <h2>2. The 5 Pillars of a Confidenceâ€‘Driven Morning</h2>
            <h3>1) Consistent Wakeâ€‘Up and Light Exposure</h3>
            <StyledList items={[
              'Wake at a fixed time (Â±30 minutes) to regulate circadian rhythm',
              'Get 10 minutes of sunlight or use a dawnâ€‘simulation lamp'
            ]} />
            <h3 className="mt-6">2) Hydration and Nutrition</h3>
            <StyledList items={[
              'Drink 300â€“500 ml of water on waking',
              'Protein + fiber breakfast (optional) to stabilize energy'
            ]} />
            <h3 className="mt-6">3) Movement for Energy</h3>
            <p>
              5â€“10 minutes of yoga, stretching, or a brisk walk is enough to lift energy and focus. Recent work in <a href="https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2024.1471084/full">Frontiers in Psychology</a> connects brief movement bouts with stress reduction and better cognitive performance during the day.
            </p>
            <div className="my-8">
              <img
            ...
            <h3 className="mt-6">4) Mindset and Selfâ€‘Talk</h3>
            <StyledList items={[
              'Gratitude journaling (3 items)',
              'Affirmations: â€œI am focused, calm, and capable.â€',
              'Cognitive reframing when negative thoughts appear'
            ]} />
            <h3 className="mt-6">5) Focus and Planning</h3>
            <StyledList items={[
              'Identify 1â€“3 outcomes for the day (small but meaningful)',
              'Timeâ€‘block the first deepâ€‘work session early',
          ...
          <section id="sample-routine" className="mb-16 scroll-mt-24">
            ...
            <StyledList items={[
              '6:30 â€“ Wake + sunlight exposure',
              '6:32 â€“ Hydrate (water with lemon)',
              '6:35 â€“ 10 min yoga / mobility',
              '6:45 â€“ 5 min gratitude + a kind intention for the day',
              '6:50 â€“ Write top 3 outcomes + visualize one small win',
              '7:00 â€“ Shower / unhurried breakfast if desired',
              '7:20 â€“ Begin your first focus block (â€œeat the frogâ€)'
            ]} />
          ...
          <section id="customize" className="mb-16 scroll-mt-24">
            ...
            <StyledList items={[
              'Night owls: keep the same order, just shift the clock â€” regularity matters most',
              'Busy pros: use the â€œmicroâ€‘routineâ€ (water + one line of gratitude + one priority in < 5 minutes)',
              'Students: add a 5â€‘minute review or flashcards',
            ...
            <p className="mt-4">
              If chronic stress is a factor, pair your routine with proven stressâ€‘reduction supports (see <a href="https://www.nhlbi.nih.gov/news/2025/risk-score-offers-new-way-assess-impact-stress-can-have-heart">NHLBI</a> and recent
          ...
          <section id="challenges" className="mb-16 scroll-mt-24">
            ...
            <StyledList items={[
              'â€œI donâ€™t have time.â€ â†’ shrink to 3 minutes (water + one intention + one priority)',
              'â€œI forget.â€ â†’ habitâ€‘stack to an existing cue like coffee brewing',
              'â€œI canâ€™t stay consistent.â€ â†’ track tiny streaks; celebrate 3â€‘day chains',
              'â€œI check my phone first.â€ â†’ charge outside the bedroom (APA recommends reducing early exposure)',
              'â€œI wake unmotivated.â€ â†’ prep clothes, water, and journal the night before'
            ]} />
            <StyledBlockquote>
              â€œHow you wake up each day and your morning routine dramatically impacts your levels of success in every area of your life.â€ â€” Hal Elrod
            </StyledBlockquote>
          </section>
          ...
          <section className="mb-16">
            ...
            <StyledBlockquote>
              Brief, consistent movement in the morning is linked with better stress regulation and clearer thinking later in the day â€” even when sessions are short. Recent work in Frontiers in Psychology highlights these benefits.
            ...
            <StyledBlockquote>
              Protecting attention early â€” delaying social feeds and email â€” can stabilize mood and reduce reactivity. The American Psychological Association summarizes research on how social platforms influence mental states.
          ...
          <section id="faq" className="mb-16 scroll-mt-24">
            ...
            <p>
              A simple sequence of habits â€” hydration, light, gentle movement, a kind mindset check, and one small plan â€” that primes your brain and body for a steadier, more focused day.
            </p>
            <h3 className="mt-4">How long should it last?</h3>
            <p>
              Anywhere from 5â€“60 minutes. Consistency matters more than duration. Even three minutes counts when it happens most days.
            </p>
            ...
            <p>
              Many people notice clearer focus within 1â€“2 weeks, with deeper confidence changes in 3â€“4 weeks as your new identity takes root.
            </p>
            <h3 className="mt-4">What if I miss a day?</h3>
            <p>
              You didnâ€™t fail â€” youâ€™re human. Reset the next morning. Aim for progress, not perfection; compassion keeps consistency alive.
            </p>
            <p className="mt-6 text-sm text-brand-primary">
              For safety or mentalâ€‘health support, see the <a href="https://www.nimh.nih.gov/health/find-help">NIMH resources</a> or reach out to the <a href="https://988lifeline.org/">988 Lifeline</a> in the United States.
            </p>
          </section>
          ...
          <section className="mb-16">
            <KeyTakeawayBox title="Final Thoughts">
              <p>
                Your mornings donâ€™t have to be heroic to be transformative. Choose kindness over intensity, and let tiny, finishable habits carry you forward. If you want next steps, explore our guides on
