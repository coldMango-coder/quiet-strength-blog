  ...
  return (
    <>
      ...
      <section id="section-4" className="mb-16 scroll-mt-24">
        ...
        <p>The connection between people-pleasing and burnout is not just anecdotal; it's a well-established psychological pattern. Hereâ€™s how the cycle typically unfolds:</p>
        <StyledList items={[
          "Overcommitment: The inability to say 'no' leads to an ever-expanding workload and schedule.",
          "Neglect of Self-Care: As your time and energy are increasingly devoted to others, your own needsâ€”for rest, healthy meals, exercise, and hobbiesâ€”are pushed to the back burner.",
      ...
      <section id="section-5" className="mb-16 scroll-mt-24">
        ...
        <StyledList items={[
          ...
          "Increased mental distance from oneâ€™s job, or feelings of negativism or cynicism related to one's job.",
