      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <article className="article-container mx-auto max-w-[720px]">
          ...
          <section id="section-1" className="mb-16 scroll-mt-24">
            ...
            <div className="my-8">
              <img loading="lazy" decoding="async" src="/images/stressed-woman-people-pleasing-burnout.webp" alt="An introverted woman looking stressed at her desk, illustrating the people-pleasing cycle that leads to burnout." className="rounded-lg shadow-md" />
          ...
          <section id="section-4" className="mb-16 scroll-mt-24">
            ...
            <div className="my-8">
              <img loading="lazy" decoding="async" src="/images/people-pleasing-cycle-diagram.webp" alt="A visual diagram illustrating the vicious cycle of people-pleasing and how it leads to burnout." className="rounded-lg shadow-md" />
          ...
          <section id="section-6" className="mb-16 scroll-mt-24">
            ...
            <div className="my-8">
              <img loading="lazy" decoding="async" src="/images/woman-practicing-assertiveness-saying-no.webp" alt="A woman practicing saying no, representing the practical toolkit for assertiveness." className="rounded-lg shadow-md" />
