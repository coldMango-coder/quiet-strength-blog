        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-2/3 text-left">
            ...
            <div className="prose prose-xl max-w-none text-brand-primary">
              <p className="mb-6">
                Iâ€™m an <strong>introvert-women burnout coach</strong> who helps high-achieving introverts rebuild confidence. For years, I tried to be someone I wasn't. I chased the extroverted ideal of success, believing that to be seen, I had to be loud. The result? I was left feeling drained, inauthentic, and completely burnt out.
              </p>
              <p className="mb-6">
