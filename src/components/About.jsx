...
// Fix: About page uses correct diacritic in title and person name; Avatar centers face with zero CLS
const About = () => {
  return (
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/3 text-center">
            <div className="mx-auto">
              <Avatar src="/images/marica-sinko-author-photo.avif" alt="Marica Šinko - Author portrait" size={224} />
            </div>
          </div>
